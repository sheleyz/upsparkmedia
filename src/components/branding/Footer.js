        ...
        <footer className={`${styles["footer"]} bg-brand-secondary text-white`}>
            <div className="container px-4 px-lg-5 pt-4">
                <div className="d-flex justify-content-center align-items-center gap-1">
                    ...
                    <a className={`btn ${styles["btn-social"]} mx-2 my-3`} href="https://upsparkmedia.etsy.com/" target="_blank" rel="noopener noreferrer" title="UpSpark Media Etsy">
            ...
            <div className="text-center pt-2 pb-4">
                <p className="mb-0">
                    Created by{" "}
                    <a href="https://zachsheley.com/" target="_blank" rel="noopener noreferrer">
                        Zach Sheley
                    </a>
                </p>
            </div>
